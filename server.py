...
def listen_for_wake_words(loop):
    ...
    try:
        configs = [
            ('index.html', 'YOUR_VOICE_COMMAND_1', 'PATH/TO/YOUR/PPN/FILE/NO/1', 'YOUR_ACCESS_KEY_1'),
            ('patient_progress.html', 'YOUR_VOICE_COMMAND_2', 'PATH/TO/YOUR/PPN/FILE/NO/2', 'YOUR_ACCESS_KEY_2'),
            ('demonstration.html', 'YOUR_VOICE_COMMAND_3', 'PATH/TO/YOUR/PPN/FILE/NO/3', 'YOUR_ACCESS_KEY_3')
        ]
        ...
        while True:
            ...
            for page, msg, porcupine_instance in porcupines:
                ...
                if result >= 0:
                    ...
                    webbrowser.open_new_tab(f'http://localhost:5000/{page}')
